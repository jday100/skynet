#ifndef T100ELEMENTBIDIRECTION_H
#define T100ELEMENTBIDIRECTION_H

#include "T100ElementBase.h"

class T100ElementBidirection : public T100ElementBase
{
    friend class T100ElementBidirectionSource;
    public:
        T100ElementBidirection();
        virtual ~T100ElementBidirection();
...
#endif // T100ELEMENTBIDIRECTION_H
