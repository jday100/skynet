...
#include "compiler/scanner/T100SentenceScanner.h"

using namespace T100LIBRARY;

T100CPPSentenceScannerTest::T100CPPSentenceScannerTest(T100Test* parent, const T100WSTRING& label) :
...
T100BOOL T100CPPSentenceScannerTest::DoTest()
{
    T100BOOL        result;

    result  = sentence_test();

    return result;
}

T100BOOL T100CPPSentenceScannerTest::sentence_test()
{
