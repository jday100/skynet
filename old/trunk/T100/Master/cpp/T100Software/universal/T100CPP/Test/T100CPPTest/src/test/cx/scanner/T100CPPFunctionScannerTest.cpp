...
#include "compiler/scanner/T100FunctionScanner.h"

using namespace T100LIBRARY;

T100CPPFunctionScannerTest::T100CPPFunctionScannerTest(T100Test* parent, const T100WSTRING& label) :
    T100Test(parent, label)
{
    //ctor
}

T100CPPFunctionScannerTest::~T100CPPFunctionScannerTest()
{
    //dtor
}

T100BOOL T100CPPFunctionScannerTest::DoTest()
{
    T100BOOL        result;
...
T100BOOL T100CPPFunctionScannerTest::function_test()
{
