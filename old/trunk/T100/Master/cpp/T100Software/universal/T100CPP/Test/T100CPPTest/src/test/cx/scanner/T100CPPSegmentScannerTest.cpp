...
#include "compiler/scanner/T100SegmentScanner.h"

using namespace T100LIBRARY;

T100CPPSegmentScannerTest::T100CPPSegmentScannerTest(T100Test* parent, const T100WSTRING& label) :
    T100Test(parent, label)
{
    //ctor
}

T100CPPSegmentScannerTest::~T100CPPSegmentScannerTest()
{
    //dtor
}

T100BOOL T100CPPSegmentScannerTest::DoTest()
{
    T100BOOL        result;
...
T100BOOL T100CPPSegmentScannerTest::segment_test()
{
