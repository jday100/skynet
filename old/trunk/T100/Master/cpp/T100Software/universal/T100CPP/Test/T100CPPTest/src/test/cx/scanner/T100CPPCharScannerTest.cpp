...
T100CPPCharScannerTest::T100CPPCharScannerTest(T100Test* parent, const T100WSTRING& label) :
    T100Test(parent, label)
{
    //ctor
}

T100CPPCharScannerTest::~T100CPPCharScannerTest()
{
    //dtor
}

T100BOOL T100CPPCharScannerTest::DoTest()
{
    T100BOOL        result;
...
T100BOOL T100CPPCharScannerTest::char_test()
{
