...
T100VOID T100ConsoleWindows::init()
{
    //setlocale(LC_ALL, "");
}

T100VOID T100ConsoleWindows::uninit()
{
...
T100VOID T100ConsoleWindows::SetForegroundColour(T100COLOUR_TYPE type)
{
    ...
    switch(type){
    case T100NATIVE::T100COLOUR_TYPE_BLACK:
        {
            colour = 0;
        }
        break;
    case T100NATIVE::T100COLOUR_TYPE_WHITE:
        {
            colour = FOREGROUND_RED | FOREGROUND_GREEN | FOREGROUND_BLUE;
        }
        break;
    case T100NATIVE::T100COLOUR_TYPE_RED:
        {
            colour = FOREGROUND_RED;
        }
        break;
    case T100NATIVE::T100COLOUR_TYPE_GREEN:
        {
            colour = FOREGROUND_GREEN;
        }
        break;
    case T100NATIVE::T100COLOUR_TYPE_BLUE:
        {
            colour = FOREGROUND_BLUE;
        }
        break;
    case T100NATIVE::T100COLOUR_TYPE_ORANGE:
        {
            colour = FOREGROUND_RED | FOREGROUND_GREEN;
        }
        break;
    case T100NATIVE::T100COLOUR_TYPE_YELLOW:
        {
            colour = FOREGROUND_RED | FOREGROUND_BLUE;
        }
        break;
    case T100NATIVE::T100COLOUR_TYPE_PURPLE:
        {
