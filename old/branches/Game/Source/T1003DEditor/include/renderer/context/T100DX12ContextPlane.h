#ifndef T100DX12CONTEXTPLANE_H
#define T100DX12CONTEXTPLANE_H

#include "T100DX12Context.h"

class T100DX12ContextPlane : public T100DX12Context
{
    public:
        T100DX12ContextPlane();
        virtual ~T100DX12ContextPlane();
