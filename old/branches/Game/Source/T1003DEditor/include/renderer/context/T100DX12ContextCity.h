#ifndef T100DX12CONTEXTCITY_H
#define T100DX12CONTEXTCITY_H

#include "T100DX12Context.h"

class T100DX12ContextCity : public T100DX12Context
{
    public:
        T100DX12ContextCity();
        virtual ~T100DX12ContextCity();
