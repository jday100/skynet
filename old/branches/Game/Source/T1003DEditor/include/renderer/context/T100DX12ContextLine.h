#ifndef T100DX12CONTEXTLINE_H
#define T100DX12CONTEXTLINE_H

#include "T100DX12Context.h"

class T100DX12ContextLine : public T100DX12Context
{
    public:
        T100DX12ContextLine();
        virtual ~T100DX12ContextLine();
