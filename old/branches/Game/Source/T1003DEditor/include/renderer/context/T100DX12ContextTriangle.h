#ifndef T100DX12CONTEXTTRIANGLE_H
#define T100DX12CONTEXTTRIANGLE_H

#include "T100DX12Context.h"

class T100DX12ContextTriangle : public T100DX12Context
{
    public:
        T100DX12ContextTriangle();
        virtual ~T100DX12ContextTriangle();
...
#endif // T100DX12CONTEXTTRIANGLE_H
