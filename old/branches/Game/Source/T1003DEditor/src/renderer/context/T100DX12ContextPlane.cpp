#include "T100DX12ContextPlane.h"

#include "T100DX12Header.h"
#include "T100DX12Tools.h"
#include "T100DX12Studio.h"

T100DX12ContextPlane::T100DX12ContextPlane() :
    T100DX12Context()
{
    //ctor
}
...
T100VOID T100DX12ContextPlane::Create()
{
    if(Bundle.USED){
        CreateBundle();
    }else{
...
T100VOID T100DX12ContextPlane::Destroy()
{

}

T100VOID T100DX12ContextPlane::Update()
{
    if(Bundle.USED){
        UpdateBundle();
    }else{
...
T100VOID T100DX12ContextPlane::Render()
{
    if(Bundle.USED){
        RenderBundle();
    }else{
...
T100VOID T100DX12ContextPlane::CreateSingle()
{
...
T100VOID T100DX12ContextPlane::UpdateSingle()
{
    XMMATRIX        projection;
    XMMATRIX        view;
    XMMATRIX        model;
...
T100VOID T100DX12ContextPlane::RenderSingle()
{
...
T100VOID T100DX12ContextPlane::CreateBundle()
{
...
T100VOID T100DX12ContextPlane::UpdateBundle()
{
...
T100VOID T100DX12ContextPlane::RenderBundle()
{
