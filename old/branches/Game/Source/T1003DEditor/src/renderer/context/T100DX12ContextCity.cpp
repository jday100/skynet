...
T100VOID T100DX12ContextCity::Create()
{
    if(Bundle.USED){
        CreateBundle();
    }else{
...
T100VOID T100DX12ContextCity::Destroy()
{

}

T100VOID T100DX12ContextCity::Update()
{
    if(Bundle.USED){
        UpdateBundle();
    }else{
...
T100VOID T100DX12ContextCity::Render()
{
    if(Bundle.USED){
        RenderBundle();
    }else{
...
T100VOID T100DX12ContextCity::CreateSingle()
{
...
T100VOID T100DX12ContextCity::UpdateSingle()
{
...
T100VOID T100DX12ContextCity::RenderSingle()
{
    ...
    m_commandList->IASetIndexBuffer(m_indexBufferViewPtr);
    ...
    m_commandList->SetPipelineState(usePso1 ? m_pipelineState1.Get() : m_pipelineState2.Get());
    usePso1 = !usePso1;
...
T100VOID T100DX12ContextCity::CreateBundle()
{
...
T100VOID T100DX12ContextCity::UpdateBundle()
{
...
T100VOID T100DX12ContextCity::RenderBundle()
{
