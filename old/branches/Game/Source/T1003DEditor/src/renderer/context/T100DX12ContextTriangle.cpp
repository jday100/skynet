#include "T100DX12ContextTriangle.h"

#include "T100DX12Header.h"
#include "T100DX12Tools.h"
#include "T100DX12Studio.h"

T100DX12ContextTriangle::T100DX12ContextTriangle() :
    T100DX12Context()
{
    //ctor
}
...
T100VOID T100DX12ContextTriangle::Create()
{
    if(Bundle.USED){
        CreateBundle();
    }else{
...
T100VOID T100DX12ContextTriangle::Destroy()
{

}

T100VOID T100DX12ContextTriangle::Update()
{
    if(Bundle.USED){
        UpdateBundle();
    }else{
...
T100VOID T100DX12ContextTriangle::Render()
{
    if(Bundle.USED){
        RenderBundle();
    }else{
...
T100VOID T100DX12ContextTriangle::CreateSingle()
{
...
T100VOID T100DX12ContextTriangle::UpdateSingle()
{
    XMMATRIX        projection;
    XMMATRIX        view;
    XMMATRIX        model;
...
T100VOID T100DX12ContextTriangle::RenderSingle()
{
...
T100VOID T100DX12ContextTriangle::CreateBundle()
{
...
T100VOID T100DX12ContextTriangle::UpdateBundle()
{
...
T100VOID T100DX12ContextTriangle::RenderBundle()
{
