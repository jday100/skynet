...
T100DX12ContextLine::T100DX12ContextLine() :
    T100DX12Context()
{
    //ctor
}
...
T100VOID T100DX12ContextLine::Create()
{
    if(Bundle.USED){
        CreateBundle();
    }else{
...
T100VOID T100DX12ContextLine::Destroy()
{

}

T100VOID T100DX12ContextLine::Update()
{
    if(Bundle.USED){
        UpdateBundle();
    }else{
...
T100VOID T100DX12ContextLine::Render()
{
    if(Bundle.USED){
        RenderBundle();
    }else{
...
T100VOID T100DX12ContextLine::CreateSingle()
{
...
T100VOID T100DX12ContextLine::UpdateSingle()
{
    XMMATRIX        projection;
    XMMATRIX        view;
    XMMATRIX        model;
...
T100VOID T100DX12ContextLine::RenderSingle()
{
...
T100VOID T100DX12ContextLine::CreateBundle()
{
...
T100VOID T100DX12ContextLine::UpdateBundle()
{
...
T100VOID T100DX12ContextLine::RenderBundle()
{
