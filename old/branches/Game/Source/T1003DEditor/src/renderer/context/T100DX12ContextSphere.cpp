#include "T100DX12ContextSphere.h"

#include "T100DX12Header.h"
#include "T100DX12Tools.h"
#include "T100DX12Studio.h"

T100DX12ContextSphere::T100DX12ContextSphere() :
    T100DX12Context()
{
    //ctor
}
...
T100VOID T100DX12ContextSphere::Create()
{
    if(Bundle.USED){
        CreateBundle();
    }else{
...
T100VOID T100DX12ContextSphere::Destroy()
{

}

T100VOID T100DX12ContextSphere::Update()
{
    if(Bundle.USED){
        UpdateBundle();
    }else{
...
T100VOID T100DX12ContextSphere::Render()
{
    if(Bundle.USED){
        RenderBundle();
    }else{
...
T100VOID T100DX12ContextSphere::CreateSingle()
{
...
T100VOID T100DX12ContextSphere::UpdateSingle()
{
    XMMATRIX        projection;
    XMMATRIX        view;
    XMMATRIX        model;
...
T100VOID T100DX12ContextSphere::RenderSingle()
{
...
T100VOID T100DX12ContextSphere::CreateBundle()
{
...
T100VOID T100DX12ContextSphere::UpdateBundle()
{
...
T100VOID T100DX12ContextSphere::RenderBundle()
{
