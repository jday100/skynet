#include "T1003DEditorLineGrid.h"
...
T100VOID T1003DEditorLineGrid::Update(T100Entity* entityPtr)
{
    ...
    T100Vector3     terminus    = linePtr->GetTerminus();
    ...
    m_terminusPtr->AddChild(m_terminusXPtr);
    m_terminusPtr->AddChild(m_terminusYPtr);
    m_terminusPtr->AddChild(m_terminusZPtr);
