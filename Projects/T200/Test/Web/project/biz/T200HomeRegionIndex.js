...
class T200HomeRegionIndex extends T200HomeVisitorBiz {
    ...
    load_house_rents(id, data) {
        ...
        let promise = new Promise(function(resolve, reject){
            ...
            return self.list(house.merge_region_list()).then(function(values){
    ...
    load_job_recruits(id, data) {
        ...
        let promise = new Promise(function(resolve, reject){
            ...
            return self.list(job.merge_region_list()).then(function(values){
    ...
    load_trading_sells(id, data) {
        ...
        let promise = new Promise(function(resolve, reject){
            ...
            return self.list(trading.merge_region_list()).then(function(values){
...
module.exports = T200HomeRegionIndex;