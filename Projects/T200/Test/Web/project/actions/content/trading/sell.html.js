...
async function do_content_trading_sell_list(request, response, cookie, session, resource) {
    log(__filename, "do_content_trading_sell_list");
    let self = this;
    let promise = new Promise(function(resolve, reject){
        ...
        if(T200HttpsForm.verify_id(trading.user_id)
            ...
            UserBiz.paging2(trading).then(function(result){
                ...
                list_box._list_url = "/content/trading/sell/list";
                list_box._search_url = "/content/trading/sell/search";
                list_box._change_status_url = "/content/trading/sell/list";
...
async function do_content_trading_sell_search(request, response, cookie, session, resource) {
    log(__filename, "do_content_trading_sell_search");
    let self = this;
    let promise = new Promise(function(resolve, reject){
        let trading = new T200UserTradingSell();
        let UserBiz = new T200HomeUserBiz(request, cookie, session);
...
async function do_content_trading_sell_publish(request, response, cookie, session, resource) {
    log(__filename, "do_content_trading_sell_publish");
    let self = this;
    let promise = new Promise(function(resolve, reject){
        let trading = new T200UserTradingSell();
        let UserBiz = new T200HomeUserBiz(request, cookie, session);
...
async function do_content_trading_sell_remove(request, response, cookie, session, resource) {
    log(__filename, "do_content_trading_sell_remove");
    let self = this;
    let promise = new Promise(function(resolve, reject){
        let trading = new T200UserTradingSell();
        let UserBiz = new T200HomeUserBiz(request, cookie, session);
...
global.action.use_post('/content/trading/sell/list', do_content_trading_sell_list);
global.action.use_post('/content/trading/sell/search', do_content_trading_sell_search);
global.action.use_post('/content/trading/sell/publish', do_content_trading_sell_publish);
global.action.use_post('/content/trading/sell/remove', do_content_trading_sell_remove);