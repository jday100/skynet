...
async function do_content_person_account(request, response, cookie, session, resource) {
    log(__filename, "do_content_person_account");
    let self = this;
...
global.action.use_post('/content/person/account', do_content_person_account);
