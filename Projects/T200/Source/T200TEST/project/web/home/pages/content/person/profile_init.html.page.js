...
class T200ProfileInitPage extends T200Page {
    constructor(name) {
        super(name);
        ...
        this.modules = [
            "content/person/profile_init_form"
        ];
    }
    ...
    #test_page() {
        ...
        let promise = new Promise(async function(resolve, reject){
            ...
            for(let tag of self.tags){
                if("content/person/profile_init_form" == tag.module.name){
                    form = tag;
                    break;
                }
            }
...
module.exports = T200ProfileInitPage;