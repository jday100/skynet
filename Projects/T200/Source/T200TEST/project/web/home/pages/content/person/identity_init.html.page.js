...
class T200IdentityInitPage extends T200Page {
    constructor(name) {
        super(name);
        ...
        this.modules = [
            "content/person/identity_init_form"
        ];
    }
    ...
    #test_page() {
        ...
        let promise = new Promise(async function(resolve, reject){
            ...
            for(let tag of self.tags){
                if("content/person/identity_init_form" == tag.module.name){
                    form = tag;
                    break;
                }
            }
...
module.exports = T200IdentityInitPage;