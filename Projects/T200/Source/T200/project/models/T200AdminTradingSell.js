...
class T200AdminTradingSell extends T200HomeAdminModel {
    constructor() {
        super();
    ...
    set_item_left() {
        return [
            ['Title', 'title', true, '/admin/trading/sell.html', 'list_title']
        ];
    }
    ...
    set_list_buttons() {
        return [
            ['Delete', 'list_hit_delete', 'form', 'list_box', '/admin/trading/sell/remove'],
            ['Approve', 'list_hit_approve', 'form', 'list_box', '/admin/trading/sell/approve']
        ];
    }
...
module.exports = T200AdminTradingSell;