...
class T200UserTradingBuy extends T200HomeUserModel {
    constructor() {
        super();
    ...
    set_list_buttons() {
        return [
            ['Delete', 'list_hit_delete', 'form', 'list_box', '/content/trading/buy/remove'],
            ['Publish', 'list_hit_publish', 'form', 'list_box', '/content/trading/buy/publish']
        ];
    }
    ...
    merge_user_fulltext_region_count() {
        let where;
    ...
    merge_user_fulltext_region_list() {
        let where;
...
module.exports = T200UserTradingBuy;