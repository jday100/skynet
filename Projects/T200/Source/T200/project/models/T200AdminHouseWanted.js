...
class T200AdminHouseWanted extends T200HomeAdminModel {
    constructor() {
        super();
    ...
    set_item_left() {
        return [
            ['Title', 'title', true, '/admin/house/wanted.html', 'list_title']
        ];
    }
    ...
    set_list_buttons() {
        return [
            ['Delete', 'list_hit_delete', 'form', 'list_box', '/admin/house/wanted/remove'],
            ['Approve', 'list_hit_approve', 'form', 'list_box', '/admin/house/wanted/approve']
        ];
    }
}

module.exports = T200AdminHouseWanted;