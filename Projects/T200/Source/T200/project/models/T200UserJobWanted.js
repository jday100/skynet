...
class T200UserJobWanted extends T200HomeUserModel {
    constructor() {
        super();
    ...
    set_list_buttons() {
        return [
            ['Delete', 'list_hit_delete', 'form', 'list_box', '/content/job/wanted/remove'],
            ['Publish', 'list_hit_publish', 'form', 'list_box', '/content/job/wanted/publish']
        ];
    }


    merge_user_fulltext_full_count() {
        let where;
    ...
    merge_user_fulltext_part_count() {
        let where;
    ...
    merge_user_fulltext_full_region_count() {
        let where;
    ...
    merge_user_fulltext_full_region_list() {
        let where;
    ...
    merge_user_fulltext_part_region_count() {
        let where;
    ...
    merge_user_fulltext_part_region_list() {
        let where;
...
module.exports = T200UserJobWanted;