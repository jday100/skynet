...
async function do_house_rent_long_search(request, response, cookie, session, resource) {
    log(__filename, "do_house_rent_long_search");
    let self = this;
    let promise = new Promise(function(resolve, reject){
        if(global.setup.server){
...
global.action.use_post('/house/rent/long/search', do_house_rent_long_search);