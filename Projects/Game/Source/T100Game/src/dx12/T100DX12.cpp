...
T100BOOL T100DX12::m_load_pipeline()
{
    ...
    else
    {
        ...
        m_get_hardwareAdapter(factory.Get(), &hardwareAdapter);
...

    {
        ...
        cbvSrvHeapDesc.NumDescriptors   =
            FrameCount * CityRowCount * CityColumnCount
            + 1;
...
T100BOOL T100DX12::m_get_hardwareAdapter(
...
T100BOOL T100DX12::m_load_assets()
{
