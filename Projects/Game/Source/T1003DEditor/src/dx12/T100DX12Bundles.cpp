...
T100VOID T100DX12Bundles::CreateRenderTargetView()
{
...
T100VOID T100DX12Bundles::CreateIndexBuffer(ComPtr<ID3D12Resource>& indexBufferUploadHeap, UINT8* pMeshData, UINT meshDataLength)
{
...
T100VOID T100DX12Bundles::CreateTexture(UINT& subresourceCount, UINT64& uploadBufferSize)
{
...
T100VOID T100DX12Bundles::CreateSampler(
                                      ComPtr<ID3D12Resource>& textureUploadHeap,
                                      UINT8* pMeshData,
                                      UINT meshDataLength,
                                      UINT subresourceCount,
...
T100VOID T100DX12Bundles::CreateTextureSRV()
{
    D3D12_SHADER_RESOURCE_VIEW_DESC             srvDesc         = {};
...
T100VOID T100DX12Bundles::CreateDepthStencilView()
{
...
T100VOID T100DX12Bundles::ExecuteCommandList()
{
...
T100VOID T100DX12Bundles::CreateFence()
{
...
T100VOID T100DX12Bundles::CreateFrameResources()
{
...
T100VOID T100DX12Bundles::UpdateFrameTimer()
{
...
T100VOID T100DX12Bundles::UpdateFence()
{
...
T100VOID T100DX12Bundles::UpdateCamera()
{
    m_camera.Update(static_cast<float>(m_timer.GetElapsedSeconds()));
}

T100VOID T100DX12Bundles::UpdateFrameResource()
{
...
T100VOID T100DX12Bundles::PopulateCommandList(T100DX12FrameResource* pFrameResource)
{
...
T100VOID T100DX12Bundles::ExecuteCommandListRender()
{
    ID3D12CommandList*      ppCommandLists[] = {m_commandList.Get()};
    m_commandQueue->ExecuteCommandLists(_countof(ppCommandLists), ppCommandLists);
}

T100VOID T100DX12Bundles::SwapChainPresent()
{
    ThrowIfFailed(m_swapChain->Present(1, 0));
    m_frameIndex = m_swapChain->GetCurrentBackBufferIndex();
}

T100VOID T100DX12Bundles::FenceSignal()
{
