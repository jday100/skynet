...
T100VOID T100DX12Bundles::Create(HWND hwnd, UINT width, UINT height)
{
    m_hwnd      = hwnd;
    SetSize(width, height);
}

T100VOID T100DX12Bundles::Destroy()
{
...
T100VOID T100DX12Bundles::Stop()
{

}

T100VOID T100DX12Bundles::Init()
{
...
T100VOID T100DX12Bundles::SetSize(UINT width, UINT height)
{
    m_width     = width;
    m_height    = height;
...
T100VOID T100DX12Bundles::LoadResource()
{
...
T100VOID T100DX12Bundles::LoadFile(ComPtr<ID3D12Resource>& vertexBufferUploadHeap, ComPtr<ID3D12Resource>& indexBufferUploadHeap, ComPtr<ID3D12Resource>& textureUploadHeap)
{
    {
...
T100VOID T100DX12Bundles::PopulateCommandList(T100DX12Resource* pFrameResource)
{
