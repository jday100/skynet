...
T100VOID T100DX12Entity::Create(HWND hwnd, UINT width, UINT height)
{
    m_hwnd      = hwnd;
    m_width     = width;
    m_height    = height;
...
T100VOID T100DX12Entity::Destroy()
{

}

T100VOID T100DX12Entity::SetSize(UINT width, UINT height)
{
    m_width     = width;
    m_height    = height;
}

T100VOID T100DX12Entity::Start()
{
...
T100VOID T100DX12Entity::Stop()
{

}

T100VOID T100DX12Entity::Update()
{
    if(m_entityManager.Empty())
    {
...
T100VOID T100DX12Entity::Render()
{
    if(m_entityManager.Empty())
    {
...
T100VOID T100DX12Entity::OnKeyUp(UINT8 key)
{
    m_camera.OnKeyUp(key);
}

T100VOID T100DX12Entity::LoadPipeline()
{
    CreateFactory();
    CreateDevice();
    CreateCommandQueue();
...
T100VOID T100DX12Entity::LoadPipelineEmpty()
{
    CreateFactory();
    CreateDevice();
    CreateCommandQueue();
...
T100VOID T100DX12Entity::CreateFactory()
{
...
T100VOID T100DX12Entity::CreateDevice()
{
    if(m_useWarpDevice)
    {
...
T100VOID T100DX12Entity::GetHardwareAdapter(
...
T100VOID T100DX12Entity::CreateCommandQueue()
{
...
T100VOID T100DX12Entity::CreateSwapChain()
{
...
T100VOID T100DX12Entity::CreateRtvHeap()
{
...
T100VOID T100DX12Entity::CreateDsvHeap()
{
...
T100VOID T100DX12Entity::CreateCbvHeap(UINT row, UINT column)
{
...
T100VOID T100DX12Entity::CreateSamplerHeap()
{
...
T100VOID T100DX12Entity::CreateCommandAllocator()
{
...
T100VOID T100DX12Entity::LoadAssetsSingle()
{
    /*
...
T100VOID T100DX12Entity::LoadAssets()
{
    /*
    UINT8*          pVertexShaderData;
    UINT8*          pPixelShaderData1;
...
T100VOID T100DX12Entity::LoadAssetsEmpty()
{
    CreateCommandListEmpty();
    CreateFence();
}

T100VOID T100DX12Entity::CreateRootSignature()
{
...
T100VOID T100DX12Entity::LoadShader(
...
T100VOID T100DX12Entity::CreatePipelineState(
...
T100VOID T100DX12Entity::CreateCommandList()
{
...
T100VOID T100DX12Entity::CreateCommandListEmpty()
{
    ThrowIfFailed(m_device->CreateCommandList(
                                              0,
                                              D3D12_COMMAND_LIST_TYPE_DIRECT,
...
T100VOID T100DX12Entity::CreateRenderTargetView()
{
...
T100VOID T100DX12Entity::CreateVertexBuffer(UINT VertexDataSize, UINT VertexDataOffset, UINT StandardVertexStride,
                                            ComPtr<ID3D12Resource>& vertexBufferUploadHeap,
...
T100VOID T100DX12Entity::CreateIndexBuffer(UINT IndexDataSize, UINT IndexDataOffset, const DXGI_FORMAT StandardIndexFormat,
...
T100VOID T100DX12Entity::CreateTexture(const T100City::TextureResource* Textures, UINT& subresourceCount, UINT64& uploadBufferSize)
{
...
T100VOID T100DX12Entity::CreateSampler(
...
T100VOID T100DX12Entity::CreateTextureSRV(const T100City::TextureResource* Textures)
{
    D3D12_SHADER_RESOURCE_VIEW_DESC             srvDesc         = {};
...
T100VOID T100DX12Entity::CreateDepthStencilView()
{
...
T100VOID T100DX12Entity::ExecuteCommandList()
{
    ThrowIfFailed(m_commandList->Close());
...
T100VOID T100DX12Entity::CreateFence()
{
...
T100VOID T100DX12Entity::UpdateFrameTimer()
{
...
T100VOID T100DX12Entity::UpdateFence()
{
...
T100VOID T100DX12Entity::UpdateCamera()
{
    m_camera.Update(static_cast<float>(m_timer.GetElapsedSeconds()));
}

T100VOID T100DX12Entity::UpdateFrameResource()
{
...
T100VOID T100DX12Entity::PopulateCommandList(T100BOOL useBundles, T100DX12FrameResource* pFrameResource)
{
...
T100VOID T100DX12Entity::ExecuteCommandListRender()
{
    ID3D12CommandList*      ppCommandLists[] = {m_commandList.Get()};
    m_commandQueue->ExecuteCommandLists(_countof(ppCommandLists), ppCommandLists);
}
...
T100VOID T100DX12Entity::PopulateCommandListEmpty()
{
...
T100VOID T100DX12Entity::ExecuteCommandListEmpty()
{
    ID3D12CommandList* ppCommandLists[] = {m_commandList.Get()};
    m_commandQueue->ExecuteCommandLists(_countof(ppCommandLists), ppCommandLists);
}

T100VOID T100DX12Entity::SwapChainPresent()
{
    ThrowIfFailed(m_swapChain->Present(1, 0));
    m_frameIndex = m_swapChain->GetCurrentBackBufferIndex();
}

T100VOID T100DX12Entity::FenceSignal()
{
...
T100VOID T100DX12Entity::WaitForPreviousFrame()
{
...
std::wstring T100DX12Entity::GetAssetFullPath(LPCWSTR assetName)
{
    return m_assetsPath + L"..\\..\\resources\\" + assetName;
}

void T100DX12Entity::SetCustomWindowText(LPCWSTR text)
{
    std::wstring windowText = m_title + L": " + text;
    SetWindowTextW(m_hwnd, windowText.c_str());
}

T100VOID T100DX12Entity::LoadShaderFile(
...
T100VOID T100DX12Entity::LoadMeshFile(
                                      T100WSTRING filename,
                                      UINT8** ppMeshData,
                                      UINT& meshDataLength)
{
...
T100VOID T100DX12Entity::CreateFrameResources(UINT row, UINT column)
{
    ...
    for(UINT i = 0; i < m_frameCount; i++)
    {
        T100DX12FrameResource* pFrameResource = new T100DX12FrameResource(m_device.Get(), row, column);
