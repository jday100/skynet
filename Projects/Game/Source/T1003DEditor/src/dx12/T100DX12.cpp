...
T100VOID T100DX12::CreateDsvHeap()
{
...
T100VOID T100DX12::CreateSamplerHeap()
{
...
T100VOID T100DX12::LoadAssetsSingle()
{
    /*
...
T100VOID T100DX12::CreateRootSignature()
{
...
T100VOID T100DX12::CreatePipelineState(
...
T100VOID T100DX12::CreateCommandListEmpty()
{
    ThrowIfFailed(m_device->CreateCommandList(
                                              0,
                                              D3D12_COMMAND_LIST_TYPE_DIRECT,
...
T100VOID T100DX12::CreateVertexBuffer(UINT VertexDataSize, UINT VertexDataOffset, UINT StandardVertexStride,
                                            ComPtr<ID3D12Resource>& vertexBufferUploadHeap,
...
T100VOID T100DX12::CreateIndexBuffer(UINT IndexDataSize, UINT IndexDataOffset, const DXGI_FORMAT StandardIndexFormat,
...
T100VOID T100DX12::CreateTexture(const T100City::TextureResource* Textures, UINT& subresourceCount, UINT64& uploadBufferSize)
{
...
T100VOID T100DX12::CreateSampler(
...
T100VOID T100DX12::CreateTextureSRV(const T100City::TextureResource* Textures)
{
    D3D12_SHADER_RESOURCE_VIEW_DESC             srvDesc         = {};
...
T100VOID T100DX12::CreateDepthStencilView()
{
...
T100VOID T100DX12::UpdateFrameTimer()
{
...
T100VOID T100DX12::UpdateCamera()
{
    m_camera.Update(static_cast<float>(m_timer.GetElapsedSeconds()));
}

T100VOID T100DX12::UpdateFrameResource()
{
...
T100VOID T100DX12::PopulateCommandList(T100BOOL useBundles, T100DX12FrameResource* pFrameResource)
{
...
T100VOID T100DX12::ExecuteCommandListRender()
{
    ID3D12CommandList*      ppCommandLists[] = {m_commandList.Get()};
    m_commandQueue->ExecuteCommandLists(_countof(ppCommandLists), ppCommandLists);
}
...
T100VOID T100DX12::PopulateCommandListEmpty()
{
...
T100VOID T100DX12::ExecuteCommandListEmpty()
{
    ID3D12CommandList* ppCommandLists[] = {m_commandList.Get()};
    m_commandQueue->ExecuteCommandLists(_countof(ppCommandLists), ppCommandLists);
}
...
T100VOID T100DX12::LoadShaderFile(
...
T100VOID T100DX12::LoadMeshFile(
                                      T100WSTRING filename,
                                      UINT8** ppMeshData,
                                      UINT& meshDataLength)
{
...
T100VOID T100DX12::CreateFrameResources(UINT row, UINT column)
{
