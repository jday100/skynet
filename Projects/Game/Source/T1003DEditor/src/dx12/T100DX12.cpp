...
T100VOID T100DX12::Update()
{
    ...
    */
    ...
    m_currentResourceIndex                  = (m_currentResourceIndex + 1) % m_frameCount;
    m_pCurrentResource                      = m_resources[m_currentResourceIndex];

    if (m_pCurrentResource->m_fenceValue != 0 && m_pCurrentResource->m_fenceValue > lastCompletedFence)
    {
        ThrowIfFailed(m_fence->SetEventOnCompletion(m_pCurrentResource->m_fenceValue, m_fenceEvent));
...
T100VOID T100DX12::CreateResources()
{
    ...
    for (UINT i = 0; i < m_frameCount; i++)
    {
        ...
        m_resources.push_back(pFrameResource);
    }
}
