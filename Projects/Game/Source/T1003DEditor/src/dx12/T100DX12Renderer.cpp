...
T100VOID T100DX12Renderer::OnKeyDown(UINT8 key)
{
    m_camera.OnKeyDown(key);
}

T100VOID T100DX12Renderer::OnKeyUp(UINT8 key)
{
...
T100VOID T100DX12Renderer::LoadResource()
{
...
T100VOID T100DX12Renderer::LoadFile(ComPtr<ID3D12Resource>& vertexBufferUploadHeap, ComPtr<ID3D12Resource>& indexBufferUploadHeap, ComPtr<ID3D12Resource>& textureUploadHeap)
{
    {
...
void T100DX12Renderer::SetCustomWindowText(LPCWSTR text)
{
...
T100VOID T100DX12Renderer::GetHardwareAdapter(
...
T100VOID T100DX12Renderer::CreateFrameResources()
{
...
T100VOID T100DX12Renderer::PopulateCommandList(T100DX12Resource* pFrameResource)
{
