...
T100VOID T100DXEntity::CreateCbvHeap()
{
...
T100VOID T100DXEntity::CreateRenderTargetViewEmpty()
{
...
T100VOID T100DXEntity::LoadAllEntities()
{

}

T100VOID T100DXEntity::LoadEntity(T100Entity* entity)
{
...
T100VOID T100DXEntity::LoadMeshData(UINT8** ppMeshData, UINT& meshDataLength)
{
    ThrowIfFailed(ReadDataFromFile(GetAssetFullPath(SampleAssets::DataFileName).c_str(), ppMeshData, &meshDataLength));
}

T100VOID T100DXEntity::CreateVertexBuffer(ComPtr<ID3D12Resource>& vertexBufferUploadHeap, UINT8* pMeshData, UINT meshDataLength)
{
...
T100VOID T100DXEntity::CreateIndexBuffer(ComPtr<ID3D12Resource>& indexBufferUploadHeap, UINT8* pMeshData, UINT meshDataLength)
{
...
T100VOID T100DXEntity::CreateTexture(UINT& subresourceCount, UINT64& uploadBufferSize)
{
...
T100VOID T100DXEntity::CreateTextureSRV()
{
...
T100VOID T100DXEntity::CreateFrameResources()
{
...
T100VOID T100DXEntity::PopulateCommandList(T100DXResource* pFrameResource)
{
