...
T100VOID T100DX12Demo::OnUpdate()
{
    ...
    m_pCurrentFrameResource         = m_frameResources[m_curentFrameResourceIndex];
...
void T100DX12Demo::OnKeyDown(UINT8 key)
{
    m_camera.OnKeyDown(key);
}

void T100DX12Demo::OnKeyUp(UINT8 key)
{
...
void T100DX12Demo::CreateFrameResources()
{
...
void T100DX12Demo::PopulateCommandList(FrameResource* pFrameResource)
{
