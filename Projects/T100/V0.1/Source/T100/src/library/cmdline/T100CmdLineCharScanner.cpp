...
T100VOID T100CmdLineCharScanner::setSource(T100Component::T100Scanner* scanner)
{
    m_scanner = dynamic_cast<T100CmdLineStringScanner*>(scanner);
}

T100Component::T100Scanner* T100CmdLineCharScanner::getSource()
{
    return m_scanner;
}

T100BOOL T100CmdLineCharScanner::next(T100Component::T100Token& token)
{
