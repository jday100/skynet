...
T100FontFileWriter::T100FontFileWriter(T100FontFile* file, T100Font* font)
    :T100Library::T100FileWriter(file->getName()),
...
T100BOOL T100FontFileWriter::write_head()
{
    ...
    head.FILE_SIGN.SIGN = T100Library::T100FILE_FONT;

    memset(head.FONT_NAME, 0, sizeof(head.FONT_NAME));
    if(!T100Library::T100String32Tools::copy(head.FONT_NAME, m_file->getFontName().to_string32().raw_data(), 128)){
        return T100FALSE;
    }
