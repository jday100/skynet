...
T100STRING                      T100VPCSetup::m_vdisk_file                  = L"vdisk.vdk";
T100STRING                      T100VPCSetup::m_font_file                   = L"font.fnt";
T100STRING                      T100VPCSetup::m_rom_file                    = L"rom.bin";
...
T100VOID T100VPCSetup::setVDiskFile(T100STRING file)
{
    m_vdisk_file = file;
}

T100STRING T100VPCSetup::getVDiskFile()
{
    T100STRING      result;
...
T100VOID T100VPCSetup::setFontFile(T100STRING file)
{
    m_font_file = file;
}

T100STRING T100VPCSetup::getFontFile()
{
    T100STRING      result;
...
T100VOID T100VPCSetup::setRomFile(T100STRING file)
{
    m_rom_file = file;
}

T100STRING T100VPCSetup::getRomFile()
{
    return m_rom_file;
}
