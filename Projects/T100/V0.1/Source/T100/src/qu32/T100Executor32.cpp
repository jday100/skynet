...
T100VOID T100Executor32::debug()
{
    ...
    case T100EXECUTOR_MODE_NEXT:
        {
            pause();
            m_host->getCallback()->notify_debug_pause();
        }
        break;
    }
}
...
T100VOID T100Executor32::execute()
{
    ...
    case T100Component::T100ORDER_CALL:
        ...
        break;
    case T100Component::T100ORDER_RETURN:
        {
            T100OrderRet        ret(m_host, this);
            result = ret.execute(value);
        }
        break;
    case T100Component::T100ORDER_INT:
        {
    ...
    case T100Component::T100ORDER_IRET:
        ...
        break;
    case T100Component::T100ORDER_JUMP:
        {
    ...
    case T100Component::T100ORDER_JNZ:
        ...
        break;
    case T100Component::T100ORDER_LOOP:
        {
    ...
    case T100Component::T100ORDER_IN:
        ...
        break;
    case T100Component::T100ORDER_OUT:
        {
            T100OrderOut        out(m_host, this);
            result = out.execute(value);
        }
        break;
    case T100Component::T100ORDER_MOVE:
        {
