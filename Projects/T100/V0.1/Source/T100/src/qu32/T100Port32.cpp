...
T100BOOL T100Port32::allotBlock(T100BlockDevice* dev, T100WORD length, T100WORD_VECTOR& blocks)
{
    ...
    for(int i=0;i<count;i++){
        ...
        T100Component::T100DEVICE_BLOCK*   data = T100NEW T100Component::T100DEVICE_BLOCK();
...
T100Component::T100DEVICE_BLOCK* T100Port32::getBlock(T100WORD id)
{
...
T100BOOL T100Port32::allotPage(T100PageDevice* dev, T100WORD length, T100WORD_VECTOR& pages)
{
    ...
    for(int i=0;i<count;i++){
        ...
        T100Component::T100DEVICE_PAGE*    data = T100NEW T100Component::T100DEVICE_PAGE();
...
T100Component::T100DEVICE_PAGE* T100Port32::getPage(T100WORD id)
{
