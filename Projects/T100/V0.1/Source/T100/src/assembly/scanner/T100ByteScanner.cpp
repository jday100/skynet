...
T100BOOL T100ByteScanner::open(T100STRING file)
{
    T100WSTRING         temp;
    T100STDSTRING       name;
    ...
    temp    = file.to_wstring();
    name    = T100Library::T100Unicode::to_string8(temp);
...
T100BOOL T100ByteScanner::next(T100Component::T100Token& token)
{
