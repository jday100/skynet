...
T100OperatorParser::T100OperatorParser(T100SentenceBase* base)
    :T100ParserBase(base)
{
    //ctor
}

T100OperatorParser::~T100OperatorParser()
{
    //dtor
}

T100BOOL T100OperatorParser::parse(T100OPERATOR& op)
{
...
READ_NEXT:
    ...
    case T100Assembly::T100KEYWORD_AOF:
        {
            return getParent()->getRegisterParser().parse(op);
        }
        break;
...
T100BOOL T100OperatorParser::parseAll(T100OPERATOR& op)
{
    T100BOOL        result          = T100FALSE;
...
READ_NEXT:
    ...
    case T100Assembly::T100KEYWORD_AOF:
        {
            return getParent()->getRegisterParser().parseAll(op);
        }
        break;
    case T100Assembly::T100CONSTANT_INTEGER:
    case T100Assembly::T100CONSTANT_FLOAT:
