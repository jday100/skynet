...
T100BOOL T100ElementText::MouseLeftDown(T100INT x, T100INT y)
{
    m_starting_x    = x;
    m_starting_y    = y;
...
T100BOOL T100ElementText::MouseLeftUp(T100INT x, T100INT y)
{
    m_ending_x      = x;
    m_ending_y      = y;
...
T100BOOL T100ElementText::MouseMove(T100INT x, T100INT y)
{
    T100INT     dx, dy;
