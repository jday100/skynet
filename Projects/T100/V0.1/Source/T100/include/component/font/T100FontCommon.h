...
#define     T100FONTFILE_HASH               std::unordered_masp<T100FILE_HANDLE, T100FontFile*>
#define     T100FONTFILE_ROW_VECTOR         std::vector<T100Component::T100FONTFILE_ROW*>


namespace T100Component{

typedef struct{
    T100Library::T100FILE_HEAD           FILE_SIGN;
...
typedef struct{
    T100Library::T100UNICODE32           UNICODE32;
    T100WORD                BEGIN;
    T100WORD                END;
    T100WORD                SEEK;
    T100WORD                LENGTH;
