...
class T100Port32
{
    public:
        ...
        T100Component::T100DEVICE_BLOCK*           getBlock(T100WORD);

        T100BOOL                    allotPage(T100PageDevice*, T100WORD, T100WORD_VECTOR&);
        T100Component::T100DEVICE_PAGE*            getPage(T100WORD);

    protected:
        T100DEVICE_HASH             m_device_hash;
        T100DEVICE_BLOCK_HASH       m_block_hash;
        T100DEVICE_PAGE_HASH        m_page_hash;
    ...
    private:
        ...
        T100DEVICE_BLOCK_VECTOR     m_blocks;
        T100DEVICE_PAGE_VECTOR      m_pages;
