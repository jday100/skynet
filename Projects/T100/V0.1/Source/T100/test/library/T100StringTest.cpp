...
T100BOOL T100StringTest::test_std16()
{
    ...
    T100Log::info(T100TEST_HINT_LIBRARY_STRING_STD16_TEST_START);
    ...
    show_result(result, T100TEST_HINT_LIBRARY_STRING_STD16_TEST_STOP);
    return result;
}
...
T100BOOL T100StringTest::test_std32()
{
    ...
    T100Log::info(T100TEST_HINT_LIBRARY_STRING_STD32_TEST_START);
    ...
    show_result(result, T100TEST_HINT_LIBRARY_STRING_STD32_TEST_STOP);
    return result;
}

T100BOOL T100StringTest::test_base()
{
    T100BOOL        result          = T100TRUE;
    T100BOOL        value;

    T100Log::info(T100TEST_HINT_LIBRARY_STRING_BASE_TEST_START);
    ...
    if(result){
        if("2" != source)result = T100FALSE;
        if("3" != target)result = T100FALSE;

        if(source != "2")result = T100FALSE;
        if(target != "3")result = T100FALSE;
    }
    if(result){
        if(source == target)result = T100FALSE;
    }
    ...
    show_result(result, T100TEST_HINT_LIBRARY_STRING_BASE_TEST_STOP);
    return result;
}
...
T100BOOL T100StringTest::test_wstring()
{
    ...
    T100Log::info(T100TEST_HINT_LIBRARY_STRING_WSTRING_TEST_START);
    ...
    show_result(result, T100TEST_HINT_LIBRARY_STRING_WSTRING_TEST_STOP);
    return result;
}
...
T100BOOL T100StringTest::test_string()
{
    ...
    T100Log::info(T100TEST_HINT_LIBRARY_STRING_CUSTOM_TEST_START);
    ...
    show_result(result, T100TEST_HINT_LIBRARY_STRING_CUSTOM_TEST_STOP);
    return result;
}
...
T100BOOL T100StringTest::test_tools()
{
    ...
    T100Log::info(T100TEST_HINT_LIBRARY_STRING_TOOLS_TEST_START);

    T100STDSTRING               source;
    T100STDSTRING               target;
    T100STRING_CODED_TYPE       type;

    if(result){
        source  = "一";
        type    = T100StringTools::test((T100CHAR8*)source.c_str());

        if(T100STRING_CODED_GBK != type)result = T100FALSE;
    }

    if(result){
        target  = T100StringTools::gbk_to_utf8(source);
        type    = T100StringTools::test((T100CHAR8*)target.c_str());

        if(T100STRING_CODED_UTF8 != type)result = T100FALSE;
    }

    show_result(result, T100TEST_HINT_LIBRARY_STRING_TOOLS_TEST_STOP);
    return result;
}
...
T100BOOL T100StringTest::test_unicode()
{
    ...
    T100Log::info(T100TEST_HINT_LIBRARY_STRING_UNICODE_TEST_START);
    ...
    show_result(result, T100TEST_HINT_LIBRARY_STRING_UNICODE_TEST_STOP);
    return result;
}
