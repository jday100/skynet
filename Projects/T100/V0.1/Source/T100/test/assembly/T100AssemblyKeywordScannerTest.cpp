...
T100WSTRING         T100AssemblyKeywordScannerTest::m_name                      = L"scanner.keyword";

T100AssemblyKeywordScannerTest::T100AssemblyKeywordScannerTest(T100Test* parent)
    :T100Test(parent, m_name)
{
    //ctor
}

T100AssemblyKeywordScannerTest::~T100AssemblyKeywordScannerTest()
{
    //dtor
}

T100BOOL T100AssemblyKeywordScannerTest::do_test()
{
...
T100BOOL T100AssemblyKeywordScannerTest::test_keyword()
{
    T100BOOL        result          = T100TRUE;
    T100BOOL        value;

    T100Library::T100Log::info(T100TEST_HINT_ASSEMBLY_SCANNER_BYTE_TEST_START);
    ...
    if(result){
        file        = T100ThisAppSetup::getTestResources(L"assembly\\scanner\\test_keyword.txt");
