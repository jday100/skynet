...
T100BOOL T100Order::execute_log(T100WORD value)
{
    T100BOOL        result;
...
T100BOOL T100Order::execute_none(T100WORD value)
{
    m_order = value;
    return run();
}
...
{
    return (T100QU32*)m_host;
}

T100Executor32* T100Order::getExecutor()
{
    return (T100Executor32*)m_exec;
}
    ...
    case T_MEM:
        {
            ...
            op.BASE.VALUE       = getHost()->getMemory32()->read(op.BASE.OFFSET);
        }
        break;
    case I_COR:
        {
    ...
    case I_MEM:
        {
            ...
            op.BASE.OFFSET              = getHost()->getMemory32()->read(op.BASE.INTERIM_OFFSET);
            op.BASE.VALUE               = getHost()->getMemory32()->read(op.BASE.OFFSET);
        }
        break;
    default:
    ...
    case T_MEM:
        {
            ...
            op.OPERATOR.VALUE       = getHost()->getMemory32()->read(op.OPERATOR.OFFSET);
        }
        break;
    case I_COR:
        {
    ...
    case I_MEM:
        {
            ...
            op.OPERATOR.OFFSET              = getHost()->getMemory32()->read(op.OPERATOR.INTERIM_OFFSET);
            op.OPERATOR.VALUE               = getHost()->getMemory32()->read(op.OPERATOR.OFFSET);
        }
        break;
    default:
...
T100BOOL T100Order::getSource(T100OPERATOR_DOUBLE& op, T100WORD& value)
{
    ...
    case T_NONE:
        {
            if(op.BASE.USED){
                value = getHost()->getMemory32()->read(op.BASE.VALUE, op.OPERATOR.VALUE);
            }else{
                value = op.OPERATOR.VALUE;
            }
        }
    ...
    case I_MEM:
        {
            if(op.BASE.USED){
                T100WORD offset = getHost()->getMemory32()->read(op.BASE.VALUE, op.OPERATOR.VALUE);
                value = getHost()->getMemory32()->read(0, offset);
            }else{
                return T100FALSE;
            }
    ...
    case T100OPERATOR_ONE_ONE:
        {
            ...
            value   = getHost()->getManager32()->in(offset);
        }
        break;
    case T100OPERATOR_THREE_THREE:
        {
...
T100BOOL T100Order::setTarget(T100OPERATOR_DOUBLE& op, T100WORD value)
{
    ...
    case T_NONE:
        {
            if(op.BASE.USED){
                getHost()->getMemory32()->write(op.BASE.VALUE, op.OPERATOR.VALUE, value);
            }else{
    ...
    case I_MEM:
        {
            if(op.BASE.USED){
                T100WORD offset = getHost()->getMemory32()->read(op.BASE.VALUE, op.OPERATOR.VALUE);
                getHost()->getMemory32()->write(0, offset, value);
            }else{
                return T100FALSE;
            }
        }
    ...
    case T_NONE:
        {
            ...
            getHost()->getManager32()->out(offset, value);
        }
        break;
    case T_IMM:
        {
...
T100BOOL T100Order::setMemory(T100OPERATOR_SINGLE& op, T100WORD value)
{
    ...
    case I_ARR:
        {
            ...
            offset = getHost()->getMemory32()->read(op.OFFSET + op.INDEX);
    ...
    case ST_MEM:
        {
            getHost()->getMemory32()->write(0, op.OFFSET, value);
        }
        break;
    case ST_ARR:
        {
            getHost()->getMemory32()->write(0, op.OFFSET + op.INDEX, value);
        }
        break;
    case SI_MEM:
        {
    ...
    case SI_ARR:
        {
            ...
            offset = getHost()->getMemory32()->read(0, op.OFFSET + op.INDEX);
            getHost()->getMemory32()->write(0, offset, value);
        }
        break;
    default:
    ...
    case T_MEM:
        {
            ...
            op.VALUE            = getHost()->getMemory32()->read(op.OFFSET);
        }
        break;
    case T_ARR:
        {
            ...
            op.VALUE            = getHost()->getMemory32()->read(op.OFFSET + op.INDEX);
        }
        break;
    case I_MEM:
        {
            ...
            op.OFFSET           = getHost()->getMemory32()->read(op.INTERIM_OFFSET);
            op.VALUE            = getHost()->getMemory32()->read(op.OFFSET);
        }
        break;
    case I_ARR:
        {
            ...
            op.INTERIM_OFFSET   = getHost()->getCU32()->step();
            op.INDEX            = getHost()->getCU32()->step();
            op.OFFSET           = getHost()->getMemory32()->read(op.INTERIM_OFFSET + op.INDEX);
            op.VALUE            = getHost()->getMemory32()->read(op.OFFSET);
        }
        break;
    case ST_IMM:
    ...
    case ST_MEM:
        {
            op.ADDR_TYPE        = A_MEM;
            op.OFFSET           = getHost()->getCU32()->step();
            op.VALUE            = getHost()->getMemory32()->read(0, op.OFFSET);
        }
        break;
    case ST_ARR:
        {
            ...
            op.OFFSET           = getHost()->getCU32()->step();
            op.INDEX            = getHost()->getCU32()->step();
            op.VALUE            = getHost()->getMemory32()->read(0, op.OFFSET + op.INDEX);
        }
        break;
    case SI_MEM:
        {
            op.ADDR_TYPE        = A_IND;
            op.INTERIM_OFFSET   = getHost()->getCU32()->step();
            op.OFFSET           = getHost()->getMemory32()->read(0, op.INTERIM_OFFSET);
            op.VALUE            = getHost()->getMemory32()->read(0, op.OFFSET);
        }
        break;
    case SI_ARR:
        {
            ...
            op.INTERIM_OFFSET   = getHost()->getCU32()->step();
            op.INDEX            = getHost()->getCU32()->step();
            op.OFFSET           = getHost()->getMemory32()->read(0, op.INTERIM_OFFSET + op.INDEX);
            op.VALUE            = getHost()->getMemory32()->read(0, op.OFFSET);
        }
        break;
    default:
