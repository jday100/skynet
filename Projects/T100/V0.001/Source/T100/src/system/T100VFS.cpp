...
T100BOOL T100VFS::format(T100STDSTRING name)
{
...
T100BOOL T100VFS::format(T100STDSTRING name, T100STDSTRING boot)
{
    T100BOOL        result      = T100TRUE;
    T100BOOL        value;
    T100VFS_PART*   part        = T100NULL;
    ...
    if(value){
        ...
        if(part && 1 == part->BOOT){
            ...
            value = T100FileTools::load(boot, file, 0);
            if(value){
...
T100BOOL T100VFS::mkdir(T100STDSTRING name, T100STDSTRING path)
{
    T100BOOL        result      = T100TRUE;
    T100BOOL        value;
    T100VFS_PART*   part        = T100NULL;
...
T100BOOL T100VFS::chdir(T100STDSTRING name, T100STDSTRING path)
{
    T100BOOL        result      = T100TRUE;
    T100BOOL        value;
    T100VFS_PART*   part        = T100NULL;
...
T100BOOL T100VFS::rmdir(T100STDSTRING name, T100STDSTRING path)
{
    T100BOOL        result      = T100TRUE;
    T100BOOL        value;
    T100VFS_PART*   part        = T100NULL;
...
T100BOOL T100VFS::create(T100STDSTRING name, T100STDSTRING file)
{
    T100BOOL        result      = T100TRUE;
    T100BOOL        value;
    T100VFS_PART*   part        = T100NULL;
...
T100BOOL T100VFS::remove(T100STDSTRING name, T100STDSTRING file)
{
    T100BOOL        result      = T100TRUE;
    T100BOOL        value;
    T100VFS_PART*   part        = T100NULL;
...
T100BOOL T100VFS::list(T100STDSTRING name, T100STDSTRING path)
{
    T100BOOL        result      = T100TRUE;
    T100BOOL        value;
    T100VFS_PART*   part        = T100NULL;
...
T100BOOL T100VFS::copy(T100STDSTRING source, T100STDSTRING name, T100STDSTRING target)
{
    T100BOOL        result      = T100TRUE;
    T100BOOL        value;
    T100VFS_PART*   part        = T100NULL;
    ...
    T100STDSTRING   sdir, sfile;
    T100STDSTRING   tdir, tfile;
    T100STDSTRING   path;
