...
T100STDSTRING       T100OSTestBoot::m_unit      = "os.boot";


T100OSTestBoot::T100OSTestBoot(T100App* app)
    :T100Test(m_unit), m_app(app)
{
    //ctor
}

T100OSTestBoot::~T100OSTestBoot()
{
    //dtor
}

T100BOOL T100OSTestBoot::init()
{
    ...
    if(result){
        ...
        source  = T100VPCSetup::getTestOSScript("test_init.txt");
...
T100BOOL T100OSTestBoot::test_all()
{
    T100BOOL    result      = T100TRUE;
...
T100BOOL T100OSTestBoot::test_boot()
{
    T100BOOL        result      = T100TRUE;
    T100BOOL        value;
    ...
    T100Log::info(T100TEST_OS_BOOT_TEST_START);
    ...
    T100Log::info(T100TEST_OS_BOOT_TEST_STOP);
