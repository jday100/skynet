...
.L6:
 ...
 # C:\zgit\skynet\Develop\Origin\T100\T100Project\Source\T100Project\src\logic\T100ProjectLogic.cpp:21:     m_file      = T100NEW T100FileLogic();
	...
	movq	%rbx, %rcx	 # _3,
	call	_ZdlPvy	 #
	movq	%rsi, %rax	 # tmp95, D.105011
	movq	%rax, %rcx	 # D.105011,
.LEHB4:
	call	_Unwind_Resume	 #
.L7:
	movq	%rax, %rsi	 #, tmp96
 # C:\zgit\skynet\Develop\Origin\T100\T100Project\Source\T100Project\src\logic\T100ProjectLogic.cpp:22:     m_folder    = T100NEW T100FolderLogic();
	...
	movq	%rbx, %rcx	 # _9,
	call	_ZdlPvy	 #
	movq	%rsi, %rax	 # tmp96, D.105012
	movq	%rax, %rcx	 # D.105012,
	call	_Unwind_Resume	 #
	nop	
.LEHE4:
.L8:
...
.L28:
 # C:\zgit\skynet\Develop\Origin\T100\T100Project\Source\T100Project\src\logic\T100ProjectLogic.cpp:51:     T100WSTRING             filename;
	...
	movq	%rax, %rcx	 # tmp121,
	call	_ZNSt7__cxx1112basic_stringIwSt11char_traitsIwESaIwEED1Ev	 #
	movq	%rbx, %rax	 # tmp117, D.105013
	movq	%rax, %rcx	 # D.105013,
.LEHB8:
	call	_Unwind_Resume	 #
.LEHE8:
.L31:
...
.L45:
 ...
 # C:\zgit\skynet\Develop\Origin\T100\T100Project\Source\T100Project\src\logic\T100ProjectLogic.cpp:69:     T100WSTRING         name;
	...
	movq	%rax, %rcx	 # tmp155,
	call	_ZNSt7__cxx1112basic_stringIwSt11char_traitsIwESaIwEED1Ev	 #
	movq	%rbx, %rax	 # tmp153, D.105015
	movq	%rax, %rcx	 # D.105015,
.LEHB16:
	call	_Unwind_Resume	 #
.LEHE16:
.L52:
...
.LFB5455:
 ...
 # C:\zgit\skynet\Develop\Origin\T100\T100Project\Source\T100Project\src\logic\T100ProjectLogic.cpp:116:     return info.GetPath() + L"/project/" + L"project.pjt";
	.loc 1 116 25
...
.L57:
 ...
 # C:\zgit\skynet\Develop\Origin\T100\T100Project\Source\T100Project\src\logic\T100ProjectLogic.cpp:116:     return info.GetPath() + L"/project/" + L"project.pjt";
	...
	movq	%rax, %rcx	 # tmp94,
	call	_ZNSt7__cxx1112basic_stringIwSt11char_traitsIwESaIwEED1Ev	 #
	movq	%rbx, %rax	 # tmp95, D.105019
	movq	%rax, %rcx	 # D.105019,
.LEHB19:
	call	_Unwind_Resume	 #
.LEHE19:
.L58:
...
.LFB5456:
 ...
 # C:\zgit\skynet\Develop\Origin\T100\T100Project\Source\T100Project\src\logic\T100ProjectLogic.cpp:121:     return info.GetPath() + L"/project";
	.loc 1 121 25
...
.L64:
	...
	movq	-64(%rbp), %rcx	 # <retval>,
	call	_ZNSt7__cxx1112basic_stringIwSt11char_traitsIwESaIwEED1Ev	 #
	movq	%rbx, %rax	 # tmp90, D.105028
	movq	%rax, %rcx	 # D.105028,
.LEHB22:
	call	_Unwind_Resume	 #
.LEHE22:
.L65:
