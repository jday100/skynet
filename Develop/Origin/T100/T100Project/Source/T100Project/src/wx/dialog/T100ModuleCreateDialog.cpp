...
const long T100ModuleCreateDialog::ID_MODULE_NAME_TITLE     = wxNewId();
const long T100ModuleCreateDialog::ID_MODULE_NAME_VALUE     = wxNewId();
...
T100VOID T100ModuleCreateDialog::init()
{
    ...
    m_nameTitle     = T100NEW wxStaticText(this, ID_MODULE_NAME_TITLE, _("Name:"));
    m_nameValue     = T100NEW wxTextCtrl(this, ID_MODULE_NAME_VALUE);

    module->Add(m_nameTitle, 0, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
...
{
    T100SAFE_DELETE(m_nameTitle);
    T100SAFE_DELETE(m_nameValue);
}
...
T100VOID T100ModuleCreateDialog::OnApply(wxCommandEvent& event)
{
    ...
    m_info.GetIncludeFile()->SetFileName(m_info.GetLabel() + L".h");
    m_info.GetSourceFile()->SetFileName(m_info.GetLabel() + L".cpp");
